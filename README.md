...
**Literate Verification Suite & Specification Manual for Layer 6 (`FinSc-Biology`)**

`FinSc-Biology-Wiki` provides formal compile-time macro reflection proofs, QuickCheck property test suites, and literate Markdown specifications for **Layer 6** of the non-linear discrete multiset physical law ecosystem.
...
```bash
idris2 --build FinSc-Biology-Wiki.ipkg
